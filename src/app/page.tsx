  ...
  return (
    <main className="flex flex-col items-center p-10 pb-24">
      <div className="w-full max-w-3xl mx-auto px-6">
        <h1 className="text-3xl font-semibold mb-2 text-center dark:text-gray-100">🧠 Prompting Under Pressure: <br /> Research Overview</h1>
        <section className="mt-8">
          <h2 className="text-xl font-semibold mb-2 dark:text-gray-100">Research Focus</h2>
        ...
        <section className="mt-8">
          <h2 className="text-xl font-semibold mb-2 dark:text-gray-100">Research Questions</h2>
        ...
        <section className="mt-8">
          <h2 className="text-xl font-semibold mb-2 dark:text-gray-100">Motivation</h2>
          <p className="text-gray-700 dark:text-gray-300">
        ...
        <section className="mt-8">
          <h2 className="text-xl font-semibold mb-2 dark:text-gray-100">Methodology</h2>
        ...
        <section className="mt-8">
          <h2 className="text-xl font-semibold mb-2 dark:text-gray-100">Expected Contributions</h2>
          <ul className="list-disc pl-6 space-y-1 text-gray-700 dark:text-gray-300">
